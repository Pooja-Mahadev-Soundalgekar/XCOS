...
public class viewrooms extends JFrame {
    ...
    public void setupscreen3() {
        ...
        //Adding 3 images 
        JLabel jLabel1 = new JLabel(new ImageIcon("Hotel2.7.jpg"));
        JLabel jLabel2 = new JLabel(new ImageIcon("Hotel2.2.jpg"));
        JLabel jLabel3 = new JLabel(new ImageIcon("Hotel2.6.jpg"));
