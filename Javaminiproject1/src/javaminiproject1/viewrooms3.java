 ...
 * @author User
 */
public class viewrooms3 extends JFrame {
    ...
    public void setupscreen5() {
        ...
        //Adding 3 images 
        JLabel jLabel1 = new JLabel(new ImageIcon("Bang2.1.jpg"));
        JLabel jLabel2 = new JLabel(new ImageIcon("Bang2.2.jpg"));
        JLabel jLabel3 = new JLabel(new ImageIcon("Bang2.3.jpg"));
